...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='ผุ้ดูแลระบบ' AUTO_INCREMENT=4 ;
...
CREATE TABLE `alumni` (
  ...
  `FirstName` varchar(200) default NULL COMMENT 'ชื่ิอ',
  `SurName` varchar(200) default NULL COMMENT 'นามสกุล',
  `OldFirstName` varchar(200) default NULL COMMENT 'ชื่อเดิม',
  `OldSurName` varchar(200) default NULL COMMENT 'นามสกุลเดิม',
  `StdNumber` varchar(50) default NULL COMMENT 'รหัสประจำตัวนักเรียน',
  `IDCard` varchar(50) default NULL COMMENT 'รหัสบัตรประชาชน',
  `EduID` int(11) default NULL COMMENT 'ระบบการศึกษา',
  `GenID` int(11) default NULL COMMENT 'รุ่น',
  `YearStart` varchar(100) default NULL COMMENT 'ปีที่เข้า',
  `YearEnd` varchar(100) default NULL COMMENT 'ปีที่จบ',
  `Tel` varchar(50) default NULL COMMENT 'เบอร์โทร',
  `Mobile` varchar(100) default NULL COMMENT 'มือถือ',
  `Email` varchar(100) default NULL COMMENT 'ไฟล์อีเมล์',
  `LineID` varchar(100) default NULL COMMENT 'ไลน์ID',
  `Facebook` text,
  `Twitter` text,
  `create_date` datetime default NULL,
  PRIMARY KEY  (`alumni_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='ข้อมูลศิษญ์เก่า' AUTO_INCREMENT=3 ;

-- 
-- dump ตาราง `alumni`
-- 

INSERT INTO `alumni` VALUES (1, 'อำพล99', 'เทียมนุช', 'เอกx', 'ราชm', '55', '1111111111', 2, 1, '', '', '', '', '', '', '', NULL, '2015-12-17 21:15:04');
INSERT INTO `alumni` VALUES (2, 'อา', 'กาา', '', '', '', '1101800254633', 0, 0, '', '', '', '', '', '', '', NULL, '2015-12-17 21:21:54');

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `alumni_address`
-- 

CREATE TABLE `alumni_address` (
  `alumni_address_id` int(11) NOT NULL auto_increment,
  `alumni_id` int(11) NOT NULL,
  `RoomNo` varchar(200) default NULL COMMENT 'ห้องเลขที่ ',
  `ApartmentNo` varchar(200) default NULL COMMENT 'ห้องชุดที่',
  `Building` varchar(200) default NULL COMMENT 'อาคาร',
  `Class` varchar(200) default NULL COMMENT 'ชั้น',
  `HouseNumber` varchar(200) default NULL COMMENT 'บ้านเลขที่',
  `Village` varchar(200) default NULL COMMENT 'หมู่บ้าน',
  `Swine` varchar(200) default NULL COMMENT 'หมู่',
  `Alley` varchar(200) default NULL COMMENT 'ซอย',
  `Road` varchar(200) default NULL COMMENT 'ถนน',
  `District` varchar(200) default NULL COMMENT 'ตำบล',
  `County` varchar(200) default NULL COMMENT 'เขต',
  `Province` varchar(200) default NULL COMMENT 'จังหวัด',
  `Zip` varchar(200) default NULL COMMENT 'รหัสไปรษณีย์',
  `Overseas` text COMMENT 'ที่อยู่ต่างประเทศ',
  PRIMARY KEY  (`alumni_address_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='ที่อยู่ปัจจุบัน' AUTO_INCREMENT=3 ;

-- 
-- dump ตาราง `alumni_address`
-- 

INSERT INTO `alumni_address` VALUES (1, 1, '555', '115', '555', '', '', '', '', '', '', '191', '33', '1', '', '');
INSERT INTO `alumni_address` VALUES (2, 2, '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=999 ;
...
INSERT INTO `amphur` VALUES (462, '4303', 'เมืองบึงกาฬ   ', 3, 97);
INSERT INTO `amphur` VALUES (463, '4304', 'พรเจริญ   ', 3, 97);
INSERT INTO `amphur` VALUES (464, '4305', 'โพนพิสัย   ', 3, 31);
INSERT INTO `amphur` VALUES (465, '4306', 'โซ่พิสัย   ', 3, 97);
INSERT INTO `amphur` VALUES (466, '4307', 'ศรีเชียงใหม่   ', 3, 31);
INSERT INTO `amphur` VALUES (467, '4308', 'สังคม   ', 3, 31);
INSERT INTO `amphur` VALUES (468, '4309', 'เซกา   ', 3, 97);
INSERT INTO `amphur` VALUES (469, '4310', 'ปากคาด   ', 3, 97);
INSERT INTO `amphur` VALUES (470, '4311', 'บึงโขงหลง   ', 3, 97);
INSERT INTO `amphur` VALUES (471, '4312', 'ศรีวิไล   ', 3, 97);
INSERT INTO `amphur` VALUES (472, '4313', 'บุ่งคล้า   ', 3, 97);
...
-- 
-- โครงสร้างตาราง `confirm_payment`
-- 

CREATE TABLE `confirm_payment` (
  `con_payment_id` int(11) NOT NULL auto_increment,
  `bank` varchar(200) default NULL COMMENT 'ธนาคาร',
  `branch` varchar(200) default NULL COMMENT 'สาขา',
  `acc` varchar(200) default NULL COMMENT 'บัญชี',
  `kind` varchar(200) default NULL COMMENT 'วิธีการชำระ',
  `date` varchar(200) default NULL COMMENT 'วันที่',
  `time` varchar(200) default NULL COMMENT 'เวลา',
  `amount` varchar(200) default NULL COMMENT 'จำนวนเงิน',
  `create_date` datetime default NULL,
  `order_data_id` int(11) default NULL,
  `alumni_id` int(11) default NULL,
  PRIMARY KEY  (`con_payment_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='แจ้งโอนเงิน' AUTO_INCREMENT=3 ;

-- 
-- dump ตาราง `confirm_payment`
-- 

INSERT INTO `confirm_payment` VALUES (1, '11', '111', '1', '1', '1', '11', '1', '2015-12-18 15:33:07', 1, 0);
INSERT INTO `confirm_payment` VALUES (2, '11', '111', '1', '1', '1', '11', '1', '2015-12-18 15:49:05', 1, 0);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8861 ;
...
-- 
-- โครงสร้างตาราง `education_level`
-- 
...
CREATE TABLE `education_level` (
  ...
  PRIMARY KEY  (`EduID`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='ระดับการศึกษา' AUTO_INCREMENT=8 ;

-- 
-- dump ตาราง `education_level`
-- 

INSERT INTO `education_level` VALUES (1, 'อนุบาล 1 , 2 , 3', '1');
INSERT INTO `education_level` VALUES (2, 'ประถมต้น 1,2,3,4', '2');
INSERT INTO `education_level` VALUES (3, 'ประถมปลาย 5,6,7', '3');
INSERT INTO `education_level` VALUES (4, 'มัธยมต้น (ม.ศ.)1,2,3', '4');
INSERT INTO `education_level` VALUES (5, 'มัธยมต้น (ม.ศ.)4,5', '5');
INSERT INTO `education_level` VALUES (6, 'มัธยมต้น (ม.) 1,2,3', '6');
INSERT INTO `education_level` VALUES (7, 'มันธยมปลาย (ม.) 4,5,6', '7');

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `generation`
-- 

CREATE TABLE `generation` (
  `GenID` int(11) NOT NULL auto_increment,
  `YearStart` int(11) default NULL COMMENT 'ปีที่เริ่ม',
  `YearEnd` int(11) default NULL COMMENT 'ปีที่สิเ้นสุด',
  `GenNO` int(11) default NULL COMMENT 'รุ่นโรงเรีย',
  `ThirdStudy` varchar(100) default NULL COMMENT 'มศ 3',
  `M3` varchar(100) default NULL COMMENT 'ม3',
  `M6Year` varchar(100) default NULL COMMENT 'ปีที่จบ ม6',
  `GenNOM6` varchar(100) default NULL COMMENT 'รุ่น ม6',
  `GenCode` varchar(100) default NULL COMMENT 'รหัสรุ่น',
  `Reference1` varchar(200) default NULL COMMENT 'พระสงฆ์',
  `Reference2` varchar(200) default NULL COMMENT 'ครู',
  `Reference3` varchar(200) default NULL COMMENT 'ประธานรุ่น',
  `Reference4` varchar(200) default NULL COMMENT 'แกนนำรุ่น',
  PRIMARY KEY  (`GenID`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='รุ่นของโรงเรียน' AUTO_INCREMENT=4 ;

-- 
-- dump ตาราง `generation`
-- 

INSERT INTO `generation` VALUES (1, 25029, 2503, 1, '1', '*', '*', '*', 'D.S.01', 'คพ.ประยูร', 'ม.บรรจง', '', '');
INSERT INTO `generation` VALUES (3, 11111, 11111, 0, '', '', '', '3', '007', '', '', '', '');

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `order_data`
-- 

CREATE TABLE `order_data` (
  `order_data_id` int(11) NOT NULL auto_increment,
  `order_price` int(11) NOT NULL COMMENT 'จำนวนเงินทั้งหมด',
  `alumni_id` int(11) NOT NULL COMMENT 'id ศิยษ์เก่า',
  `order_status` int(1) NOT NULL COMMENT '0=ยังไม่ยื่นยัน 1=ยืนยันแล้ว',
  `payment_status` int(1) NOT NULL COMMENT '1=Paysbuy 2=โอนเงิน',
  `order_type` int(1) default NULL COMMENT '1=ซื้อโต๊ะ 2=ซื้อที่นั่ง',
  `create_date` datetime default NULL,
  `party_id` int(11) NOT NULL,
  PRIMARY KEY  (`order_data_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='รายการจอง' AUTO_INCREMENT=6 ;

-- 
-- dump ตาราง `order_data`
-- 

INSERT INTO `order_data` VALUES (1, 8000, 2, 1, 1, 1, '2015-12-17 22:40:59', 1);
INSERT INTO `order_data` VALUES (2, 1000, 1, 1, 2, 2, '2015-12-18 09:44:25', 1);
INSERT INTO `order_data` VALUES (3, 4000, 2, 1, 2, 1, '2015-12-18 18:08:27', 1);
INSERT INTO `order_data` VALUES (4, 5000, 2, 0, 2, 2, '2015-12-18 18:16:56', 1);
INSERT INTO `order_data` VALUES (5, 50000, 2, 1, 2, 2, '2015-12-18 19:23:23', 1);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='รายละเอียดที่จอง' AUTO_INCREMENT=116 ;

-- 
-- dump ตาราง `order_detail`
-- 

INSERT INTO `order_detail` VALUES (1, 1, 11, 4000, '01UJG92R');
INSERT INTO `order_detail` VALUES (2, 1, 13, 4000, '01CXQFWP');
INSERT INTO `order_detail` VALUES (3, 2, 0, 500, '01ANKXAV');
INSERT INTO `order_detail` VALUES (4, 2, 0, 500, '01GP63WL');
INSERT INTO `order_detail` VALUES (5, 3, 16, 4000, '01CHMFGT');
INSERT INTO `order_detail` VALUES (6, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (7, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (8, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (9, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (10, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (11, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (12, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (13, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (14, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (15, 4, 0, 500, NULL);
INSERT INTO `order_detail` VALUES (16, 5, 0, 500, '01M3KLM7');
INSERT INTO `order_detail` VALUES (17, 5, 0, 500, '01OPIJ81');
INSERT INTO `order_detail` VALUES (18, 5, 0, 500, '01YBSPYJ');
INSERT INTO `order_detail` VALUES (19, 5, 0, 500, '01SPEF45');
INSERT INTO `order_detail` VALUES (20, 5, 0, 500, '01MRG1YZ');
INSERT INTO `order_detail` VALUES (21, 5, 0, 500, '014P6N4X');
INSERT INTO `order_detail` VALUES (22, 5, 0, 500, '01Q70TUN');
INSERT INTO `order_detail` VALUES (23, 5, 0, 500, '010DYZOP');
INSERT INTO `order_detail` VALUES (24, 5, 0, 500, '0127S12R');
INSERT INTO `order_detail` VALUES (25, 5, 0, 500, '01C9QZWL');
INSERT INTO `order_detail` VALUES (26, 5, 0, 500, '01QRGXUF');
INSERT INTO `order_detail` VALUES (27, 5, 0, 500, '01096NOX');
INSERT INTO `order_detail` VALUES (28, 5, 0, 500, '01AZ4XAV');
INSERT INTO `order_detail` VALUES (29, 5, 0, 500, '01O5I3CT');
INSERT INTO `order_detail` VALUES (30, 5, 0, 500, '0123GTYF');
INSERT INTO `order_detail` VALUES (31, 5, 0, 500, '01ODMR4D');
INSERT INTO `order_detail` VALUES (32, 5, 0, 500, '01UF01YB');
INSERT INTO `order_detail` VALUES (33, 5, 0, 500, '01OHAJKP');
INSERT INTO `order_detail` VALUES (34, 5, 0, 500, '01QZST2F');
INSERT INTO `order_detail` VALUES (35, 5, 0, 500, '010LEV4D');
INSERT INTO `order_detail` VALUES (36, 5, 0, 500, '01ABK5MZ');
INSERT INTO `order_detail` VALUES (37, 5, 0, 500, '01W16V41');
INSERT INTO `order_detail` VALUES (38, 5, 0, 500, '01UZS96J');
INSERT INTO `order_detail` VALUES (39, 5, 0, 500, '014PAJ8H');
INSERT INTO `order_detail` VALUES (40, 5, 0, 500, '01YRST2V');
INSERT INTO `order_detail` VALUES (41, 5, 0, 500, '01WDY7SD');
INSERT INTO `order_detail` VALUES (42, 5, 0, 500, '01YN05MB');
INSERT INTO `order_detail` VALUES (43, 5, 0, 500, '01SHU38H');
INSERT INTO `order_detail` VALUES (44, 5, 0, 500, '01MJ05E3');
INSERT INTO `order_detail` VALUES (45, 5, 0, 500, '010L6JW1');
INSERT INTO `order_detail` VALUES (46, 5, 0, 500, '01U30LYJ');
INSERT INTO `order_detail` VALUES (47, 5, 0, 500, '01CTMBG9');
INSERT INTO `order_detail` VALUES (48, 5, 0, 500, '01E7KXEF');
INSERT INTO `order_detail` VALUES (49, 5, 0, 500, '010P6Z0T');
INSERT INTO `order_detail` VALUES (50, 5, 0, 500, '01M345IB');
INSERT INTO `order_detail` VALUES (51, 5, 0, 500, '01CPQJ81');
INSERT INTO `order_detail` VALUES (52, 5, 0, 500, '012V0PEF');
INSERT INTO `order_detail` VALUES (53, 5, 0, 500, '010TIBGL');
INSERT INTO `order_detail` VALUES (54, 5, 0, 500, '0127W52N');
INSERT INTO `order_detail` VALUES (55, 5, 0, 500, '01CH6BCP');
INSERT INTO `order_detail` VALUES (56, 5, 0, 500, '016J4L67');
INSERT INTO `order_detail` VALUES (57, 5, 0, 500, '01SPIN0L');
INSERT INTO `order_detail` VALUES (58, 5, 0, 500, '01IJWLQF');
INSERT INTO `order_detail` VALUES (59, 5, 0, 500, '01WPUZ41');
INSERT INTO `order_detail` VALUES (60, 5, 0, 500, '012J0LUJ');
INSERT INTO `order_detail` VALUES (61, 5, 0, 500, '01WHYZ0X');
INSERT INTO `order_detail` VALUES (62, 5, 0, 500, '01QBOLAN');
INSERT INTO `order_detail` VALUES (63, 5, 0, 500, '014PY34L');
INSERT INTO `order_detail` VALUES (64, 5, 0, 500, '01AZG16Z');
INSERT INTO `order_detail` VALUES (65, 5, 0, 500, '01G5ENSX');
INSERT INTO `order_detail` VALUES (66, 5, 0, 500, '01U7KPAN');
INSERT INTO `order_detail` VALUES (67, 5, 0, 500, '0109EFOP');
INSERT INTO `order_detail` VALUES (68, 5, 0, 500, '0163S9IV');
INSERT INTO `order_detail` VALUES (69, 5, 0, 500, '01GTYZ4L');
INSERT INTO `order_detail` VALUES (70, 5, 0, 500, '01MF4HUZ');
INSERT INTO `order_detail` VALUES (71, 5, 0, 500, '01WHY3KX');
INSERT INTO `order_detail` VALUES (72, 5, 0, 500, '01IRKTEZ');
INSERT INTO `order_detail` VALUES (73, 5, 0, 500, '0101EJC1');
INSERT INTO `order_detail` VALUES (74, 5, 0, 500, '01E349YZ');
INSERT INTO `order_detail` VALUES (75, 5, 0, 500, '014D6V41');
INSERT INTO `order_detail` VALUES (76, 5, 0, 500, '01UJ4HEF');
INSERT INTO `order_detail` VALUES (77, 5, 0, 500, '01WLAV8T');
INSERT INTO `order_detail` VALUES (78, 5, 0, 500, '01QJGTY7');
INSERT INTO `order_detail` VALUES (79, 5, 0, 500, '01GTEBWX');
INSERT INTO `order_detail` VALUES (80, 5, 0, 500, '01A7GD2R');
INSERT INTO `order_detail` VALUES (81, 5, 0, 500, '018TQJWH');
INSERT INTO `order_detail` VALUES (82, 5, 0, 500, '016RCH67');
INSERT INTO `order_detail` VALUES (83, 5, 0, 500, '010T6JGT');
INSERT INTO `order_detail` VALUES (84, 5, 0, 500, '01MBO1QR');
INSERT INTO `order_detail` VALUES (85, 5, 0, 500, '0101QVWL');
INSERT INTO `order_detail` VALUES (86, 5, 0, 500, '01AVOT6J');
INSERT INTO `order_detail` VALUES (87, 5, 0, 500, '01KPAB4L');
INSERT INTO `order_detail` VALUES (88, 5, 0, 500, '016Z496R');
INSERT INTO `order_detail` VALUES (89, 5, 0, 500, '01CTMF0H');
INSERT INTO `order_detail` VALUES (90, 5, 0, 500, '01ENG5IR');
INSERT INTO `order_detail` VALUES (91, 5, 0, 500, '01O1M7G1');
INSERT INTO `order_detail` VALUES (92, 5, 0, 500, '01QZSDIB');
INSERT INTO `order_detail` VALUES (93, 5, 0, 500, '010XQZKX');
INSERT INTO `order_detail` VALUES (94, 5, 0, 500, '0127S9QZ');
INSERT INTO `order_detail` VALUES (95, 5, 0, 500, '01O56J0P');
INSERT INTO `order_detail` VALUES (96, 5, 0, 500, '01MNSXAR');
INSERT INTO `order_detail` VALUES (97, 5, 0, 500, '01CPMN49');
INSERT INTO `order_detail` VALUES (98, 5, 0, 500, '01UJ8H67');
INSERT INTO `order_detail` VALUES (99, 5, 0, 500, '01CTI3CX');
INSERT INTO `order_detail` VALUES (100, 5, 0, 500, '016RO9AV');
INSERT INTO `order_detail` VALUES (101, 5, 0, 500, '01WHUZ0T');
INSERT INTO `order_detail` VALUES (102, 5, 0, 500, '01ARKDMJ');
INSERT INTO `order_detail` VALUES (103, 5, 0, 500, '01KDQZSH');
INSERT INTO `order_detail` VALUES (104, 5, 0, 500, '016N8XUZ');
INSERT INTO `order_detail` VALUES (105, 5, 0, 500, '0101YR0D');
INSERT INTO `order_detail` VALUES (106, 5, 0, 500, '01QFWHEJ');
INSERT INTO `order_detail` VALUES (107, 5, 0, 500, '01K5ERWH');
INSERT INTO `order_detail` VALUES (108, 5, 0, 500, '01YNKPIN');
INSERT INTO `order_detail` VALUES (109, 5, 0, 500, '01GHAB89');
INSERT INTO `order_detail` VALUES (110, 5, 0, 500, '01Q385UZ');
INSERT INTO `order_detail` VALUES (111, 5, 0, 500, '01GXA7GP');
INSERT INTO `order_detail` VALUES (112, 5, 0, 500, '012B8PU7');
INSERT INTO `order_detail` VALUES (113, 5, 0, 500, '01KTMZO9');
INSERT INTO `order_detail` VALUES (114, 5, 0, 500, '01UJGXQ7');
INSERT INTO `order_detail` VALUES (115, 5, 0, 500, '01S1QNCH');

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `party`
-- 

CREATE TABLE `party` (
  `party_id` int(11) NOT NULL auto_increment,
  `PartyName` varchar(255) default NULL,
  `PartyDate` date default NULL COMMENT 'วันที่จัด',
  `PartyStatus` int(1) NOT NULL COMMENT '0=เปิกให้จอง 1=ปิดจอง',
  `PartySeatPrices` int(11) NOT NULL COMMENT 'ราคาต่อ1ที่นั่ง',
  `PartyPriceTable` int(10) default NULL COMMENT 'ราคาต่อโต๊ะ',
  `PartyImg` varchar(200) NOT NULL COMMENT 'ผังที่นั่ง',
  PRIMARY KEY  (`party_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='ชื่องาน' AUTO_INCREMENT=2 ;

-- 
-- dump ตาราง `party`
-- 

INSERT INTO `party` VALUES (1, 'คืนสู่เหย้า ดาราสมุทรศรีราชา', '2015-12-15', 0, 500, 4000, '20151216112936.jpg');

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `party_table`
-- 

CREATE TABLE `party_table` (
  `party_table_id` int(11) NOT NULL auto_increment,
  `party_id` int(11) NOT NULL,
  `PartyTableCode` varchar(100) default NULL COMMENT 'รหัสโต๊ะ',
  `PartyTableNumber` int(10) NOT NULL COMMENT 'จำนวนโต๊ะ',
  `PartyTableDetail` text NOT NULL COMMENT 'รายละเอียดเพิ่มเติม',
  `status` int(1) NOT NULL default '0' COMMENT '0=ยังไม่จอง 1=จองแล้ว',
  `alumni_id` int(11) default NULL COMMENT 'id ผู้จอง',
  PRIMARY KEY  (`party_table_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='โต๊ะจีน' AUTO_INCREMENT=31 ;

-- 
-- dump ตาราง `party_table`
-- 

INSERT INTO `party_table` VALUES (1, 1, 'A0001', 7, '', 1, 1);
INSERT INTO `party_table` VALUES (2, 1, 'A0002', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (3, 1, 'A0003', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (4, 1, 'A0004', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (5, 1, 'A0005', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (6, 1, 'A0006', 7, '', 1, 1);
INSERT INTO `party_table` VALUES (7, 1, 'A0007', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (8, 1, 'A0008', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (9, 1, 'A0009', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (10, 1, 'A0010', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (11, 1, 'B0001', 7, '', 1, 2);
INSERT INTO `party_table` VALUES (12, 1, 'B0002', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (13, 1, 'B0003', 7, '', 1, 2);
INSERT INTO `party_table` VALUES (14, 1, 'B0004', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (15, 1, 'B0005', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (16, 1, 'B0006', 7, '', 1, 2);
INSERT INTO `party_table` VALUES (17, 1, 'B0007', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (18, 1, 'B0008', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (19, 1, 'B0009', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (20, 1, 'B0010', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (21, 1, 'B0011', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (22, 1, 'B0012', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (23, 1, 'B0013', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (24, 1, 'B0014', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (25, 1, 'B0015', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (26, 1, 'B0016', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (27, 1, 'B0017', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (28, 1, 'B0018', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (29, 1, 'B0019', 7, '', 0, NULL);
INSERT INTO `party_table` VALUES (30, 1, 'B0020', 7, '', 0, NULL);
